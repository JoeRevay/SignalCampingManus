/**
 * TripRouteLanding — Placeholder page. Signal data not yet available.
 */
...
export default function TripRouteLanding() {
  useEffect(() => { document.title = "Trip Route Campgrounds | SignalCamping"; }, []);
  return (
    <div className="min-h-screen bg-gradient-to-br from-stone-50 via-white to-green-50/30">
      ...
      <div className="container py-16 text-center max-w-lg mx-auto">
        ...
        <p className="text-gray-500 mb-6">
          This page will be available once we've collected real trip route campgrounds data for campgrounds in the Great Lakes region. We're working on gathering verified measurements.
        </p>
